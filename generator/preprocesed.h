...
struct ImPlotPoint {
    ...
    double& operator[] (size_t idx) {                                                  (void) ((!!(                                                 idx == 0 || idx == 1                                                 )) || (_assert(                                                 "idx == 0 || idx == 1"                                                 ,"../implot/implot.h",473),0))                                                                                ; return ((double*)(void*)(char*)this)[idx]; }
    double operator[] (size_t idx) const {                                                  (void) ((!!(                                                 idx == 0 || idx == 1                                                 )) || (_assert(                                                 "idx == 0 || idx == 1"                                                 ,"../implot/implot.h",474),0))                                                                                ; return ((const double*)(const void*)(const char*)this)[idx]; }
};
struct ImPlotRange {
    double Min, Max;
...
template <typename T> void PlotDigital(const char* label_id, const T* xs, const T* ys, int count, ImPlotDigitalFlags flags=0, int offset=0, int stride=sizeof(T));
 ...
 void Annotation(double x, double y, const ImVec4& col, const ImVec2& pix_offset, bool clamp, const char* fmt, ...) __attribute__((format(gnu_printf, 6, 6 +1)));
 void AnnotationV(double x, double y, const ImVec4& col, const ImVec2& pix_offset, bool clamp, const char* fmt, va_list args) __attribute__((format(gnu_printf, 6, 0)));
 void TagX(double x, const ImVec4& col, bool round = false);
 void TagX(double x, const ImVec4& col, const char* fmt, ...) __attribute__((format(gnu_printf, 3, 3 +1)));
 void TagXV(double x, const ImVec4& col, const char* fmt, va_list args) __attribute__((format(gnu_printf, 3, 0)));
 void TagY(double y, const ImVec4& col, bool round = false);
 void TagY(double y, const ImVec4& col, const char* fmt, ...) __attribute__((format(gnu_printf, 3, 3 +1)));
 void TagYV(double y, const ImVec4& col, const char* fmt, va_list args) __attribute__((format(gnu_printf, 3, 0)));
...
static inline bool ImNan(double val) { return                                              __builtin_choose_expr ( __builtin_types_compatible_p (__typeof__ (                                             val                                             ), double), __isnan(                                             val                                             ), __builtin_choose_expr ( __builtin_types_compatible_p (__typeof__ (                                             val                                             ), float), __isnanf(                                             val                                             ), __builtin_choose_expr ( __builtin_types_compatible_p (__typeof__ (                                             val                                             ), long double), __isnanl(                                             val                                             ), (__builtin_trap(),                                             val                                             ))))                                                       ; }
...
struct ImPlotAnnotationCollection {
    ...
    void AppendV(const ImVec2& pos, const ImVec2& off, ImU32 bg, ImU32 fg, bool clamp, const char* fmt, va_list args) __attribute__((format(gnu_printf, 7, 0))) {
        ImPlotAnnotation an;
    ...
    void Append(const ImVec2& pos, const ImVec2& off, ImU32 bg, ImU32 fg, bool clamp, const char* fmt, ...) __attribute__((format(gnu_printf, 7, 7 +1))) {
        va_list args;
...
struct ImPlotTagCollection {
    ...
    void AppendV(ImAxis axis, double value, ImU32 bg, ImU32 fg, const char* fmt, va_list args) __attribute__((format(gnu_printf, 6, 0))) {
        ImPlotTag tag;
        tag.Axis = axis;
        tag.Value = value;
        tag.ColorBg = bg;
    ...
    void Append(ImAxis axis, double value, ImU32 bg, ImU32 fg, const char* fmt, ...) __attribute__((format(gnu_printf, 6, 6 +1))) {
        va_list args;
       __builtin_va_start(       args       ,       fmt       )                          ;
